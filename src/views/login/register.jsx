      ...
      <Form onSubmit={this.handleSubmit} style={style.register} className="register">
        ...
        <FormItem>
          {getFieldDecorator('agreement', {
            ...
            <Checkbox>我已同意 <a href="">注册协议</a></Checkbox>
          )}
        </FormItem>
        <FormItem>
          <Button type="primary" htmlType="submit" style={style.btn}>注册</Button>
        </FormItem>
      </Form>
    )
  }
